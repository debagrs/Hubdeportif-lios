        ...
        <section className="lab-section lab-divider">
          <div className="lab-container">
            <div className="section-head">
              ...
              <p>O Hub herda o design system do LabInterface; o conteúdo, as imagens e as escolhas internas de cada portfólio pertencem ao estudante.</p>
            </div>
          ...
          <div className="lab-container">
            ...
            <div className="portfolio-grid">
              ...
              <article className="portfolio-card" style={{ ['--student-accent' as string]: '#86EFAC' }}>
                <div><Layers3 size={36} color="#86EFAC" /><h3>Identidade própria</h3><p>A infraestrutura é comum, mas cada estudante pode ajustar cor de destaque, apresentação e organização dos projetos.</p></div>
